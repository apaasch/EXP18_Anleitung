...
\subsection{Event Displays mit dem iSpy Webinterface}
Das iSpy Webinterface ermöglicht es die Prozesse w\"arend einer Kollision und die Signale im Detektor darzustellen. Sie finden das Program unter der Webseite https://ispy-webgl.web.cern.ch/
\begin{lstlisting}
